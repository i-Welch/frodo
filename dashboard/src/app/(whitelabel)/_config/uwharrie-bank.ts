...
export const uwharrieBank: WhiteLabelConfig = {
  slug: 'uwharrie-bank',
  ...
  products: [
    ...
    },
    {
      ...
      type: 'mortgage',
      label: 'Mortgage',
      blurb: 'Buy, refinance, or build in Stanly, Cabarrus, Anson, or Mecklenburg County with a local mortgage team.',
      iconPath: 'M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z M9 22V12h6v10',
      minAmount: 50000,
      maxAmount: 1500000,
    ...
    },
    {
      ...
      blurb: 'Business loans, SBA, and USDA commercial financing from the only commercial bank headquartered in Stanly County.',
  ...
  coreSync: {
    system: 'unknown',
    displayName: 'your existing core',
    mode: 'mock',
  },

  loTeam: {
    name: 'Uwharrie Bank Lending',
