...
export const southAtlanticBank: WhiteLabelConfig = {
  ...
  branding: {
    ...
    wordmark: 'SOUTH ATLANTIC BANK',
    tagline: 'Proud to Serve the Carolina Coast',
    primary: '#1E417C',
    primaryDark: '#163260',
    accent: '#AC893F',
    bg: '#f5f7f9',
  ...
  products: [
    ...
    },
    {
      ...
      type: 'mortgage',
      label: 'Mortgage',
      blurb: 'Local mortgage team serving primary, vacation, and coastal jumbo buyers',
      iconPath: 'M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z M9 22V12h6v10',
      minAmount: 50000,
      maxAmount: 1500000,
    ...
    },
    {
      ...
      blurb: 'Coastal SBA, CRE, and working capital lending for Grand Strand businesses',
  ...
  loTeam: {
    name: 'South Atlantic Bank Lending',
