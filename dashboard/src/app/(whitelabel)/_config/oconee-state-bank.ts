...
export const oconeStateBank: WhiteLabelConfig = {
  ...
  products: [
    {
      id: 'mortgage',
      type: 'mortgage',
      label: 'Remarkable Mortgage',
      blurb: 'Fixed and adjustable-rate purchase and refinance loans, local servicing, fast local decisions.',
    ...
    },
    {
      id: 'business',
      type: 'business',
      label: 'Business & Commercial Lending',
      blurb: 'Commercial real estate, operating lines, equipment, and SBA loans for Georgia businesses.',
  ...
  coreSync: {
    system: 'unknown',
    displayName: 'your core',
    mode: 'mock',
  },
  loTeam: {
    name: 'Oconee State Bank Lending',
