...
export const firstCommunityBankSc: WhiteLabelConfig = {
  ...
  branding: {
    ...
    wordmark: 'FIRST COMMUNITY BANK',
    tagline: 'See the difference a community banker can make.',
    primary: '#003f7d',
    primaryDark: '#002d5a',
    accent: '#e87722',
    bg: '#f5f7f9',
  ...
  products: [
    ...
    },
    {
      ...
      type: 'mortgage',
      label: 'Mortgage',
      blurb: 'Purchase, refinance, or build across South Carolina and Georgia with a community mortgage team.',
      iconPath: 'M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z M9 22V12h6v10',
      minAmount: 50000,
      maxAmount: 1500000,
    ...
    },
    {
      ...
      blurb: 'Local decisions for Midlands and metro Augusta businesses, from working capital to commercial real estate.',
  ...
  loTeam: {
    name: 'First Community Bank Lending',
