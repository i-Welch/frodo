...
export const bankOfTravelersRest: WhiteLabelConfig = {
  ...
  branding: {
    ...
    shortName: 'Travelers Rest Bank',
    wordmark: 'BANK OF TRAVELERS REST',
    tagline: 'With each visit and every interaction, our goal is quality customer care.',
    primary: '#1a3a6b',
    primaryDark: '#122850',
    accent: '#2e6db4',
    bg: '#f5f7f9',
  ...
  products: [
    ...
    },
    {
      ...
      type: 'mortgage',
      label: 'Mortgage',
      blurb: 'Purchase or refinance with a local Travelers Rest mortgage team.',
      iconPath: 'M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z M9 22V12h6v10',
      minAmount: 50000,
      maxAmount: 1500000,
    ...
    },
    {
      ...
      blurb: 'Working capital, equipment, and CRE financing for Greenville-area businesses.',
  ...
  loTeam: {
    name: 'Bank of Travelers Rest Lending',
