...
export const firstPalmettoBank: WhiteLabelConfig = {
  ...
  branding: {
    ...
    wordmark: 'FIRST PALMETTO BANK',
    tagline: 'Serving South Carolina since 1904',
    primary: '#1a5c38',
    primaryDark: '#124028',
    accent: '#c9a227',
    bg: '#f5f7f9',
  ...
  products: [
    ...
    },
    {
      ...
      type: 'mortgage',
      label: 'Mortgage',
      blurb: 'Work with a First Palmetto mortgage banker who knows your South Carolina market.',
      iconPath: 'M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z M9 22V12h6v10',
      minAmount: 50000,
      maxAmount: 1500000,
    ...
    },
    {
      ...
      blurb: 'Local bankers across four SC regions ready to fund your next commercial step.',
  ...
  loTeam: {
    name: 'First Palmetto Bank Lending',
