...
export const countybank: WhiteLabelConfig = {
  slug: 'countybank',
  ...
  products: [
    ...
    },
    {
      ...
      type: 'mortgage',
      label: 'Mortgage',
      blurb: 'Buy, refinance, or build with in-house underwriting from our Greenwood mortgage team.',
      iconPath: 'M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z M9 22V12h6v10',
      minAmount: 50000,
      maxAmount: 1500000,
    ...
    },
    {
      ...
      blurb: 'Custom loans, SBA financing, and lines of credit from local Upstate SC lenders.',
