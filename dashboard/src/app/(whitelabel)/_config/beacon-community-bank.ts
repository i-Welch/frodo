...
export const beaconCommunityBank: WhiteLabelConfig = {
  ...
  branding: {
    ...
    shortName: 'Beacon',
    wordmark: 'BEACON COMMUNITY BANK',
    tagline: 'We\'ll give you every reason to love your bank for the very first time.',
    primary: '#0d3d6e',
    primaryDark: '#092c50',
    accent: '#c8973a',
    bg: '#f5f7f9',
  ...
  products: [
    ...
    },
    {
      ...
      type: 'mortgage',
      label: 'Mortgage',
      blurb: 'Purchase or refinance a Lowcountry home with a local mortgage officer who knows your market.',
      iconPath: 'M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z M9 22V12h6v10',
      minAmount: 50000,
      maxAmount: 1500000,
    ...
    },
    {
      ...
      blurb: 'Local decisions on equipment, commercial real estate, and business lines — made right here in the Lowcountry.',
  ...
  loTeam: {
    name: 'Beacon Community Bank Lending',
