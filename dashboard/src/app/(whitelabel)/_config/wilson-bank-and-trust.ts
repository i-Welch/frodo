...
export const wilsonBankAndTrust: WhiteLabelConfig = {
  ...
  products: [
    ...
    },
    {
      ...
      type: 'mortgage',
      label: 'Mortgage',
      blurb: 'Buy, refinance, or build across Middle Tennessee with a local mortgage team.',
      iconPath: 'M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z M9 22V12h6v10',
      minAmount: 50000,
      maxAmount: 1500000,
    ...
    },
    {
      ...
      blurb: 'Business loans and lines of credit from a relationship manager who knows Wilson County.',
