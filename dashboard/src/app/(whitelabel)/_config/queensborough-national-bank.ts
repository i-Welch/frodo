...
export const queensboroughNationalBank: WhiteLabelConfig = {
  ...
  branding: {
    ...
    wordmark: 'QUEENSBOROUGH NATIONAL BANK',
    tagline: 'Georgia\'s Community Bank',
    primary: '#027052',
    primaryDark: '#0f6a4e',
    accent: '#e6af10',
    bg: '#f5f7f9',
  ...
  products: [
    ...
    },
    {
      ...
      type: 'mortgage',
      label: 'Mortgage',
      blurb: 'Conventional, FHA, VA, USDA, and specialty loans from local mortgage officers in your Georgia community.',
      iconPath: 'M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z M9 22V12h6v10',
      minAmount: 50000,
      maxAmount: 1500000,
    ...
    },
    {
      ...
      blurb: 'Lines of credit, equipment, CRE, agricultural, and SBA loans with local decisions across central and coastal Georgia.',
  ...
  loTeam: {
    name: 'Queensborough National Bank & Trust Company Lending',
    title: 'Consumer, Mortgage & Agricultural Lending',
  },
};
