...
export const conwayNationalBank: WhiteLabelConfig = {
  ...
  products: [
    ...
    },
    {
      ...
      type: 'mortgage',
      label: 'Mortgage',
      blurb: 'Purchase or refinance your Grand Strand home with a CNB mortgage lender.',
      iconPath: 'M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z M9 22V12h6v10',
      minAmount: 50000,
      maxAmount: 1500000,
    ...
    },
    {
      ...
      blurb: 'Local commercial and small business financing for Grand Strand entrepreneurs.',
  ...
  loTeam: {
    name: 'The Conway National Bank Lending',
