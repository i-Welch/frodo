...
export const coastalCarolinaNationalBank: WhiteLabelConfig = {
  ...
  branding: {
    ...
    shortName: 'CCNB',
    wordmark: 'COASTAL CAROLINA NATIONAL BANK',
    tagline: 'We Can Do That',
    primary: '#2a7a3b',
    primaryDark: '#1f5c2c',
    accent: '#5ab56e',
    bg: '#f5f7f9',
  ...
  products: [
    ...
    },
    {
      ...
      type: 'mortgage',
      label: 'Mortgage',
      blurb: 'Conventional, jumbo, condotel, construction, and portfolio loans from local mortgage officers across coastal SC and NC.',
      iconPath: 'M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z M9 22V12h6v10',
      minAmount: 50000,
      maxAmount: 1500000,
    ...
    },
    {
      ...
      blurb: 'Working capital, equipment, and commercial real estate with local decisions from our Myrtle Beach lending team.',
  ...
  loTeam: {
    name: 'Coastal Carolina National Bank Lending',
