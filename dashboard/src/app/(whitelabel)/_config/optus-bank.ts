...
export const optusBank: WhiteLabelConfig = {
  slug: 'optus-bank',
  ...
  branding: {
    ...
    shortName: 'Optus',
    wordmark: 'OPTUS BANK',
    tagline: 'Banking on Communities',
    primary: '#1a5c38',
    primaryDark: '#134429',
    accent: '#c8973a',
    bg: '#f5f7f9',
  ...
  products: [
    ...
    },
    {
      ...
      type: 'mortgage',
      label: 'Mortgage',
      blurb: 'Fixed and adjustable-rate mortgages from South Carolina\'s only Black-owned bank.',
      iconPath: 'M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z M9 22V12h6v10',
      minAmount: 50000,
      maxAmount: 1500000,
    ...
    },
    {
      ...
      blurb: 'Lines of credit, equipment, real estate, and SBA loans for SC businesses building community wealth.',
  ...
  loTeam: {
    name: 'Optus Bank Lending',
    title: 'Consumer & Community Lending',
  },
};
