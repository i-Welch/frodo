...
export const securityFederalBank: WhiteLabelConfig = {
  ...
  branding: {
    ...
    wordmark: 'SECURITY FEDERAL BANK',
  ...
  products: [
    ...
    },
    {
      ...
      type: 'mortgage',
      label: 'Mortgage',
      blurb: 'Purchase, refinance, or build in the Aiken-Augusta corridor with a local mortgage officer.',
      iconPath: 'M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z M9 22V12h6v10',
      minAmount: 50000,
      maxAmount: 1500000,
    ...
    },
    {
      ...
      blurb: 'SBA 7(a), 504, term loans, and commercial real estate for Aiken and Augusta-area businesses.',
  ...
  loTeam: {
    name: 'Security Federal Bank Lending',
