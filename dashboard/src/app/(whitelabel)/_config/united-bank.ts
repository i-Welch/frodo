...
export const unitedBank: WhiteLabelConfig = {
  ...
  products: [
    ...
    },
    {
      ...
      blurb: 'Commercial real estate, operating lines, equipment, and SBA loans for businesses across the Mid-Atlantic and Southeast.',
