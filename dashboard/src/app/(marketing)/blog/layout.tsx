...
import { PullquoteReveal } from './pullquote-reveal';
    ...
    <>
      <style>{`
        ...
        .article-body blockquote.pullquote {
          ...
          background: linear-gradient(135deg, rgba(108,142,255,0.09) 0%, rgba(108,142,255,0.02) 100%);
        ...
        .article-body blockquote.pullquote.in-view {
          opacity: 1;
          transform: none;
        }
        ...
        .article-body div.stat-callout.in-view {
          opacity: 1;
          transform: none;
        }
        .article-body div.stat-callout strong:first-of-type {
          display: block;
          font-size: 2.25rem;
          font-weight: 700;
        ...
        .article-mid-cta-btn:hover { opacity: 0.85; }
        .article-mid-cta-alt {
          margin-top: 1.25rem;
        ...
        <section className="blog-cta">
          <div className="blog-cta-inner">
            ...
            <p>
              ...
              Book a 20-minute call and we&apos;ll walk through a live demo for your bank.
            </p>
            <CalendlyButton source="blog-footer" label="Book a Demo Call" buttonClassName="form-btn" />
