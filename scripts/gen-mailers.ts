...
const banks: Bank[] = [
  ...
  },
  {
    ...
    nameMailing: "First Palmetto Bank",
    nameShort: "First Palmetto",
    recipient: "Andrew Daniel",
    title: "SVP Technology &amp; Operations Innovation",
    street: "407 DeKalb St",
    cityStateZip: "Camden, SC 29020",
    slug: "first-palmetto-bank",
    rslug: "andrew-daniel",
  ...
  },
  {
    ...
    nameMailing: "First Reliance Bank",
    nameShort: "First Reliance",
    recipient: "Zachery Brown",
    title: "SVP Director of Customer Solutions",
    street: "2170 West Palmetto Street",
    cityStateZip: "Florence, SC 29501",
    slug: "first-reliance-bank",
    rslug: "zachery-brown",
  ...
  },
  {
    ...
    nameMailing: "First Reliance Bank",
    nameShort: "First Reliance",
    recipient: "Ben Brazell",
    title: "SEVP Chief Experience Officer",
    street: "2170 West Palmetto Street",
    cityStateZip: "Florence, SC 29501",
    slug: "first-reliance-bank",
    rslug: "ben-brazell",
  ...
  },
  {
    ...
    nameMailing: "Colony Bankcorp",
    nameShort: "Colony Bank",
    recipient: "Barry Blevins",
    title: "Treasury Solutions Advisor Lead",
    street: "115 S Grant St",
    cityStateZip: "Fitzgerald, GA 31750",
    slug: "colony-bankcorp",
    rslug: "barry-blevins",
  ...
  {
    nameCover: "Oconee State<br>Bank",
    nameMailing: "Oconee State Bank",
    nameShort: "Oconee State",
    recipient: "John Davis",
    title: "EVP Chief Innovation &amp; Technology Officer",
    street: "35 N. Main Street",
    cityStateZip: "Watkinsville, GA 30677",
    slug: "oconee-state-bank",
    rslug: "john-davis",
    cert: "18143",
    roiExp: "$179K", roiCon: "$94K", roiOpt: "$290K",
    labor: "~$175K", pull: "~$5K",
    gaps: [
      { ch: "Mortgage", detail: "No online application — Remarkable Mortgage mentioned but no apply link", st: "m" },
      { ch: "Personal / Consumer", detail: "Branch or phone only. No digital intake", st: "m" },
      { ch: "HELOC / Home Equity", detail: "Product listed but no apply path", st: "m" },
      { ch: "Business / Commercial", detail: "Relationship banking — all intake requires contacting a banker", st: "m" },
      { ch: "Account Opening", detail: "Off-domain redirect. Brand continuity breaks on mobile", st: "p" },
      { ch: "Existing Customers", detail: "Digital banking functional", st: "o" },
    ],
    gapSummary: "0 of 6 loan products available to start online today.",
    leftTitle: "What We'd Build for Oconee State",
    ctaTitle: "See the Oconee State Experience Live",
    ctaNote: "Includes the ROI model, experience analysis, and a live demo of Oconee State Bank's digital intake.",
  },
  {
    nameCover: "Ameris Bank",
    nameMailing: "Ameris Bank",
    nameShort: "Ameris",
    recipient: "Connie Romay",
    title: "SVP Retail Delivery &amp; Innovation Manager",
    street: "3490 Piedmont Rd NE",
    cityStateZip: "Atlanta, GA 30305",
    slug: "ameris-bank",
    rslug: "connie-romay",
    cert: "20504",
    roiExp: "$1.99M", roiCon: "$1.10M", roiOpt: "$3.15M",
    labor: "~$1.93M", pull: "~$58K",
    gaps: [
      { ch: "Mortgage", detail: "Third-party portal (mymortgage-online.com) — off-brand for a $25B bank", st: "p" },
      { ch: "Personal / Consumer", detail: "No digital application. Phone or branch contact required", st: "m" },
      { ch: "HELOC / Home Equity", detail: "No standalone online application path", st: "m" },
      { ch: "Business / Commercial", detail: "Relationship banking — all commercial intake begins with a banker", st: "m" },
      { ch: "Account Opening", detail: "Online account opening routes to third-party provider", st: "p" },
      { ch: "Existing Customers", detail: "Online and mobile banking fully functional", st: "o" },
    ],
    gapSummary: "1 of 6 products available to start online today (partial).",
    leftTitle: "What We'd Build for Ameris",
    ctaTitle: "See the Ameris Experience Live",
    ctaNote: "Includes the ROI model, experience analysis, and a live demo of Ameris Bank's digital intake.",
  },
  {
    nameCover: "United Bank",
    nameMailing: "United Bank",
    nameShort: "United Bank",
    recipient: "Thomas Bontempo",
    title: "SVP Director of Digital Strategy",
    street: "6821 Carnegie Blvd, Ste 7200",
    cityStateZip: "Charlotte, NC 28211",
    slug: "united-bank",
    rslug: "thomas-bontempo",
    cert: "5672",
    roiExp: "$2.33M", roiCon: "$1.28M", roiOpt: "$3.69M",
    labor: "~$2.26M", pull: "~$68K",
    gaps: [
      { ch: "Mortgage", detail: "Online app exists but no automated verification — manual document chase follows submission", st: "p" },
      { ch: "Personal / Consumer", detail: "Partially digital — form available but manual verification follows", st: "p" },
      { ch: "HELOC / Home Equity", detail: "No standalone online application path — branch or phone required", st: "m" },
      { ch: "Business / Commercial", detail: "Relationship model — all commercial intake begins with a relationship manager", st: "m" },
      { ch: "Account Opening", detail: "Online and mobile account opening available", st: "p" },
      { ch: "Existing Customers", detail: "Online and mobile banking fully functional", st: "o" },
    ],
    gapSummary: "2 of 6 products available to start online today (no verification).",
    leftTitle: "What We'd Build for United Bank",
    ctaTitle: "See the United Bank Experience Live",
    ctaNote: "Includes the ROI model, experience analysis, and a live demo of United Bank's digital intake.",
  },
];
